...
menuElements.insertAdjacentHTML('afterBegin','<button type="button" role="button" id="menutoggle" style="display: none;" aria-hidden="true"><span class="navicon-lines"></span>menu</button>');
